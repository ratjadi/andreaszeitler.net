...
class CreateZipFile { 
    ...
    public function zipDirectory($dirName, $outputDir, $zipName) { 
        ...
        for ($i=0;$i<$count;$i++){ 
            ...
            // das array und der offset zurückgesetzt, sowie
            // die Länge der bisherigen Daten gespeichert -> wichtig, s.u.!!!
        ...
        // Vorsicht: vor EOF die richtige Länge der Zip-Daten!
        $data = implode("", $this->compressedData); 
        $controlDirectory = implode("", $this->centralDirectory); 
        ...
        pack("v", sizeof($this->centralDirectory)). 
        pack("V", strlen($controlDirectory)). 
        pack("V", $this->compressedDataLength+strlen($data)). // richtige Länge, nämlich alles was oben
